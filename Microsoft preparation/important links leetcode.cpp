...
/8
next permutation, house robber 1, house robber 2 3, frog jumps, atcoder dp problems, B+ trees
-rotate an image by 90ndereee,, median in two sorted arrays
stacks + design problems 
hashmap design 
*/
